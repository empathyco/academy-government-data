 ...
 * @public
 */
var BannerSchema = __assign(__assign({}, IdentifiableSchema), { tagging: {
        click: TaggingRequestSchema
    }, image: expect.any(String), modelName: expect.any(String), title: expect.any(String), url: expect.any(String) });
 ...
 * @public
 */
var FilterSchema = __assign(__assign({}, IdentifiableSchema), { modelName: expect.any(String), selected: expect.any(Boolean) });
/**
 * Jest schema for validating FacetFilter entities.
 *
 * @public
 */
var FacetFilterSchema = __assign(__assign({}, FilterSchema), { facetId: expect.anyOf([Number, String]), modelName: expect.any(String) });
/**
 * Jest schema for validating RawFilter entities.
 *
 * @public
 */
var RawFilterSchema = __assign(__assign({}, FilterSchema), { modelName: 'RawFilter', id: expect.any(String), selected: true });
/**
 * Jest schema for validating BooleanFilter entities.
 *
 * @public
 */
var BooleanFilterSchema = __assign(__assign({}, FacetFilterSchema), { modelName: expect.any(String), label: expect.any(String), totalResults: expect.undefinedOr(Number) });
/**
 ...
 * @public
 */
var HierarchicalFilterSchema = __assign(__assign({}, BooleanFilterSchema), { parentId: expect.nullOrAnyOf([Number, String]), children: expect.undefinedOr(Array), modelName: 'HierarchicalFilter' });
/**
 * Jest schema for validating NumberRangeFilter entity.
 *
 * @public
 */
var NumberRangeFilterSchema = __assign(__assign({}, BooleanFilterSchema), { range: { min: expect.nullOr(Number), max: expect.nullOr(Number) }, modelName: 'NumberRangeFilter' });
/**
 * Jest schema for validating EditableNumberRangeFilterSchema entity.
 *
 * @public
 */
var EditableNumberRangeFilterSchema = __assign(__assign({}, FacetFilterSchema), { range: { min: expect.nullOr(Number), max: expect.nullOr(Number) }, modelName: 'EditableNumberRangeFilter' });
 ...
 * @public
 */
var FacetSchema = __assign(__assign({}, IdentifiableSchema), { label: expect.any(String), filters: expect.arrayOfItemsMatching(FilterSchema), modelName: expect.any(String) });
/**
 * Jest schema for validating SimpleFacet entity.
 *
 * @public
 */
var SimpleFacetSchema = __assign(__assign({}, FacetSchema), { filters: expect.arrayOfItemsMatching(SimpleFilterSchema), modelName: 'SimpleFacet' });
/**
 * Jest schema for validating HierarchicalFacet entity.
 *
 * @public
 */
var HierarchicalFacetSchema = __assign(__assign({}, FacetSchema), { filters: expect.arrayOfItemsMatching(HierarchicalFilterSchema), modelName: 'HierarchicalFacet' });
/**
 * Jest schema for validating NumberRangeFacet entity.
 *
 * @public
 */
var NumberRangeFacetSchema = __assign(__assign({}, FacetSchema), { filters: expect.arrayOfItemsMatching(NumberRangeFilterSchema), modelName: 'NumberRangeFacet' });
/**
 * Jest schema for validating EditableNumberRangeFacet entity.
 *
 * @public
 */
var EditableNumberRangeFacetSchema = __assign(__assign({}, FacetSchema), { filters: expect.arrayOfItemsMatching(EditableNumberRangeFilterSchema), modelName: 'EditableNumberRangeFacet' });
 ...
 * @public
 */
var PromotedSchema = __assign(__assign({}, IdentifiableSchema), { tagging: {
        click: TaggingRequestSchema
    }, image: expect.any(String), modelName: expect.any(String), title: expect.any(String), url: expect.any(String) });
 ...
 * @public
 */
var RedirectionSchema = __assign(__assign({}, IdentifiableSchema), { tagging: {
        click: TaggingRequestSchema
    }, modelName: 'Redirection', url: expect.any(String) });
 ...
 * @public
 */
var ResultSchema = __assign(__assign({}, IdentifiableSchema), { identifier: {
        value: expect.any(String)
    }, images: expect.arrayOf(String), modelName: expect.any(String), name: expect.any(String), price: {
        ...
        add2cart: TaggingRequestSchema,
        checkout: TaggingRequestSchema
    }, type: expect.any(String), url: expect.any(String), isWishlisted: expect.any(Boolean) });
/**
 * Jest schema for validating Recommendation (AKA Result) entities.
 *
 * @public
 */
var RecommendationSchema = __assign(__assign({}, IdentifiableSchema), { identifier: {
        value: expect.any(String)
    }, images: expect.arrayOf(String), modelName: expect.any(String), name: expect.any(String), price: {
        originalValue: expect.any(Number),
        value: expect.any(Number),
