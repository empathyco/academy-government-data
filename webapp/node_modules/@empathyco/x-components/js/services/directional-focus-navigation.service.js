...
class DirectionalFocusNavigationService {
     ...
     */
    updateOrigin() {
        const newOrigin = document.activeElement;
    ...
    getDistanceScore(candidate) {
        ...
        const euclideanDistance = Math.sqrt(Math.pow(absoluteDistances.x, 2) + Math.pow(absoluteDistances.y, 2));
...
//# sourceMappingURL=directional-focus-navigation.service.js.map
