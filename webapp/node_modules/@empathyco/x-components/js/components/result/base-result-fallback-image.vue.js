import script from './base-result-fallback-image.vue_rollup-plugin-vue_script.vue.js';
...
var __vue_render__ = function (_h, _vm) {
  ...
  return _c(
    "svg",
    {
      class: ["x-picture__image x-picture__image--fallback"].concat(
...
//# sourceMappingURL=base-result-fallback-image.vue.js.map
