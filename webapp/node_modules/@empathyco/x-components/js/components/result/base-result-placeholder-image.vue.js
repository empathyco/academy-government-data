import script from './base-result-placeholder-image.vue_rollup-plugin-vue_script.vue.js';
...
var __vue_render__ = function (_h, _vm) {
  ...
  return _c(
    "svg",
    {
      class: ["x-picture__image x-picture__image--placeholder"].concat(
...
//# sourceMappingURL=base-result-placeholder-image.vue.js.map
