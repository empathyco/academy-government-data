 ...
 */
function getPreviousProvideObject(previousProvide, componentInstance) {
 ...
 */
function getPreviousInjectObject(previousInject) {
 ...
 */
function isProvideFunction(provide) {
    return typeof provide === 'function';
}

export { XInject, XProvide };
