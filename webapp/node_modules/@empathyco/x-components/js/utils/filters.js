 ...
 * @public
 */
function areFiltersDifferent(someFilters, anotherFilters) {
    return (someFilters.length !== anotherFilters.length ||
 ...
 * @public
 */
function createRawFilters(filterIds) {
...
export { areFiltersDifferent, createRawFilters };
