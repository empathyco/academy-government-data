 ...
 * @public
 */
let FacetsMixin = class FacetsMixin extends Vue {
    /**
    ...
    get selectedFilters() {
        if (this.facetsIds) {
            return this.facetsIds.reduce((selectedFilters, facetId) => [...selectedFilters, ...this.selectedFiltersByFacet[facetId]], []);
        }
...
__decorate([
    Prop()
], FacetsMixin.prototype, "facetsIds", void 0);
__decorate([
    Prop({ default: false })
], FacetsMixin.prototype, "alwaysVisible", void 0);
__decorate([
    Getter('facets', 'selectedFiltersByFacet')
], FacetsMixin.prototype, "selectedFiltersByFacet", void 0);
__decorate([
    Getter('facets', 'selectedFilters')
], FacetsMixin.prototype, "selectedFiltersGetter", void 0);
FacetsMixin = __decorate([
    Component
], FacetsMixin);
var FacetsMixin$1 = FacetsMixin;

export { FacetsMixin$1 as default };
//# sourceMappingURL=facets.mixin.js.map
