 ...
 * @public
 */
let ExcludeFiltersWithNoResults = class ExcludeFiltersWithNoResults extends mixins(FiltersInjectionMixin) {
    /**
     ...
     * @internal
     */
    get filtersWithResults() {
        return this.renderedFilters.filter(filter => !isBooleanFilter(filter) || filter.totalResults !== 0);
    }
    render(h) {
...
__decorate([
    XProvide('filters')
], ExcludeFiltersWithNoResults.prototype, "filtersWithResults", null);
ExcludeFiltersWithNoResults = __decorate([
    Component({
        mixins: [xComponentMixin(facetsXModule)]
    })
], ExcludeFiltersWithNoResults);
var script = ExcludeFiltersWithNoResults;

export { script as default };
//# sourceMappingURL=exclude-filters-with-no-results.vue_rollup-plugin-vue_script.vue.js.map
