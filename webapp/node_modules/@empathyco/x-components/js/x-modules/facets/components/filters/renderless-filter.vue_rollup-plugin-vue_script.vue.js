 ...
 * @public
 */
let RenderlessFilter = class RenderlessFilter extends Vue {
    /**
    ...
    emitEvents() {
        Object.entries(this.events).forEach(([event, payload]) => {
            this.$x.emit(event, payload, { target: this.$el });
        });
    }
    /**
...
__decorate([
    Prop({ required: true })
], RenderlessFilter.prototype, "filter", void 0);
__decorate([
    Prop()
], RenderlessFilter.prototype, "clickEvents", void 0);
RenderlessFilter = __decorate([
    Component({
        mixins: [xComponentMixin(facetsXModule)]
    })
], RenderlessFilter);
var script = RenderlessFilter;

export { script as default };
//# sourceMappingURL=renderless-filter.vue_rollup-plugin-vue_script.vue.js.map
