 ...
 * @public
 */
let SortedFilters = class SortedFilters extends mixins(FiltersInjectionMixin) {
    /**
    ...
    get sortedFilters() {
        if (!isArrayEmpty(this.renderedFilters) && isBooleanFilter(this.renderedFilters[0])) {
            return [...this.renderedFilters].sort(({ selected }) => {
                return selected ? -1 : 1;
            });
        }
...
__decorate([
    XProvide('filters')
], SortedFilters.prototype, "sortedFilters", null);
SortedFilters = __decorate([
    Component({
        mixins: [xComponentMixin(facetsXModule)]
    })
], SortedFilters);
var script = SortedFilters;

export { script as default };
//# sourceMappingURL=sorted-filters.vue_rollup-plugin-vue_script.vue.js.map
