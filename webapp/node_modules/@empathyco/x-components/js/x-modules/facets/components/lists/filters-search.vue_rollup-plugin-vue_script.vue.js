 ...
 * @public
 */
let FiltersSearch = class FiltersSearch extends mixins(FiltersInjectionMixin) {
    constructor() {
        super(...arguments);
        this.query = '';
        this.filtersSearchInputMessage = 'search into the filter values';
    }
    /**
    ...
    get siftedFilters() {
        ...
        return this.renderedFilters.filter(filter => isBooleanFilter(filter) && normalizeString(filter.label).includes(normalizedQuery));
    }
    /**
...
__decorate([
    Prop({ default: 200 })
], FiltersSearch.prototype, "debounceInMs", void 0);
__decorate([
    Watch('debounceInMs', { immediate: true })
], FiltersSearch.prototype, "updateSetQueryDebounced", null);
__decorate([
    XProvide('filters')
], FiltersSearch.prototype, "siftedFilters", null);
FiltersSearch = __decorate([
    Component({
        mixins: [xComponentMixin(facetsXModule)]
    })
], FiltersSearch);
var script = FiltersSearch;

export { script as default };
//# sourceMappingURL=filters-search.vue_rollup-plugin-vue_script.vue.js.map
