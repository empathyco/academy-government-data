 ...
 * @public
 */
let ClearFilters = class ClearFilters extends FacetsMixin {
    /**
...
ClearFilters = __decorate([
    Component({
        components: { BaseEventButton: __vue_component__ },
        mixins: [xComponentMixin(facetsXModule)]
    })
], ClearFilters);
var script = ClearFilters;

export { script as default };
//# sourceMappingURL=clear-filters.vue_rollup-plugin-vue_script.vue.js.map
