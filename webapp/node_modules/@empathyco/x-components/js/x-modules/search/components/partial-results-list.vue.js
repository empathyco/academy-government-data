...
var __vue_render__ = function () {
  ...
  return _vm.partialResults.length
    ? _c(
        _vm.animation,
        {
          tag: "component",
          staticClass: "x-list x-partial-results-list",
          attrs: { "data-test": "partial-results", tag: "ul" },
        },
        _vm._l(_vm.partialResults, function (partialResult, index) {
          return _c(
            "li",
            {
              key: partialResult.query + "-" + index,
              staticClass: "x-partial-result",
              attrs: { "data-test": "partial-result" },
            },
            [_vm._t("default", null, { partialResult: partialResult })],
            2
          )
        }),
        0
