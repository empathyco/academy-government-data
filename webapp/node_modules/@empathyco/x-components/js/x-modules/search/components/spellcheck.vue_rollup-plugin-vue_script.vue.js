 ...
 * @public
 */
let Spellcheck = class Spellcheck extends Vue {
};
__decorate([
    State('search', 'query')
], Spellcheck.prototype, "query", void 0);
__decorate([
    State('search', 'spellcheckedQuery')
], Spellcheck.prototype, "spellcheckedQuery", void 0);
Spellcheck = __decorate([
    Component({
        mixins: [xComponentMixin(searchXModule)]
    })
], Spellcheck);
var script = Spellcheck;

export { script as default };
//# sourceMappingURL=spellcheck.vue_rollup-plugin-vue_script.vue.js.map
