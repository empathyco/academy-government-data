 ...
 * @public
 */
let SortList = class SortList extends mixins(SortMixin) {
    /**
     * Sort list items.
     *
...
__decorate([
    Prop({ default: 'ul' })
], SortList.prototype, "animation", void 0);
SortList = __decorate([
    Component({
...
//# sourceMappingURL=sort-list.vue_rollup-plugin-vue_script.vue.js.map
