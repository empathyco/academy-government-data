 ...
 * @public
 */
const toggleRelatedTag = ({ commit, state: { selectedRelatedTags } }, relatedTag) => {
    const isRelatedTagSelected = selectedRelatedTags.includes(relatedTag);
    if (isRelatedTagSelected) {
        commit('setSelectedRelatedTags', selectedRelatedTags.filter(rt => rt !== relatedTag));
...
export { toggleRelatedTag };
//# sourceMappingURL=toggle-related-tag.action.js.map
