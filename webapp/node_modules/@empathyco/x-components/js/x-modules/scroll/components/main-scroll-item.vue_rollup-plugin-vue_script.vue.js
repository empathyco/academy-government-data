 ...
 * @public
 */
let MainScrollItem = class MainScrollItem extends Vue {
    /**
     ...
     */
    observeItem(newObserver, oldObserver) {
...
__decorate([
    Prop({ required: true })
], MainScrollItem.prototype, "item", void 0);
__decorate([
    Prop({ default: () => NoElement })
], MainScrollItem.prototype, "tag", void 0);
__decorate([
    State('scroll', 'pendingScrollTo')
], MainScrollItem.prototype, "pendingScrollTo", void 0);
__decorate([
    XInject(ScrollObserverKey)
], MainScrollItem.prototype, "firstVisibleItemObserver", void 0);
MainScrollItem = __decorate([
    Component({
        mixins: [xComponentMixin(scrollXModule)]
    })
], MainScrollItem);
var script = MainScrollItem;

export { script as default };
//# sourceMappingURL=main-scroll-item.vue_rollup-plugin-vue_script.vue.js.map
