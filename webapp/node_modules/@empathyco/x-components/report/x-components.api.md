...
import { DeepPartial as DeepPartial_2 } from '@empathyco/x-utils';
...
//
// @public
export const animateClipPath: (animationOrigin?: AnimationOrigin | undefined) => VueConstructor<default_2>;

// @public
export const animateScale: (animationOrigin?: AnimationOrigin | undefined) => VueConstructor<default_2>;

// @public
export const animateTranslate: (animationOrigin?: AnimationOrigin | undefined) => VueConstructor<default_2>;
...
export interface XModuleOptions<ModuleName extends XModuleName> {
    config?: DeepPartial_2<ExtractState<ModuleName> extends {
        config: infer Config;
    } ? Config : never>;
    wiring?: Partial<Wiring>;
}
...
export type XStoreModuleOptions<StoreModule extends AnyXStoreModule> = StoreModule extends XStoreModule<infer State, infer Getters, infer Mutations, infer Actions> ? {
    state?: DeepPartial_2<State>;
    actions?: DeepPartial_2<ActionsTree<State, Getters, Mutations, Actions>>;
    getters?: DeepPartial_2<GettersTree<State, Getters>>;
    mutations?: DeepPartial_2<MutationsTree<State, Mutations>>;
} : never;
...
// src/x-modules/search/store/emitters.ts:22:40 - (ae-forgotten-export) The symbol "TaggingRequest" needs to be exported by the entry point index.d.ts
