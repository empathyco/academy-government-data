 ...
 * @public
 */
export declare type StoreEmitters<StoreModule extends AnyXStoreModule> = {
 ...
 * @public
 */
export declare type AnySimpleStateSelector = SimpleStateSelector<any, any, any>;
/**
 * Alias for any state selector.
 *
 * @public
 */
export declare type AnyStateSelector = StateSelector<any, any, any>;
/**
