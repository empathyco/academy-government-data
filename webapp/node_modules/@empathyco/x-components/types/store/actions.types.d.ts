 ...
 * @public
 */
export declare type ExtractActionReturn<Action extends (payload?: any) => any> = ReturnType<Action> extends Promise<any> ? ReturnType<Action> : Promise<ReturnType<Action>>;
/**
 ...
 * @public
 */
export declare type ActionsDictionary<Actions> = Record<keyof Actions, (payload?: any) => any>;
/**
 ...
 * @public
 */
export declare type ActionsTree<State extends Dictionary, Getters extends Dictionary, Mutations extends MutationsDictionary<Mutations>, Actions extends ActionsDictionary<Actions>> = {
 ...
 * @public
 */
export declare type ActionsClass<Module extends AnyXStoreModule> = Partial<Module['actions']>;
