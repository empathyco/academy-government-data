...
import { AnyXModule, ExtractGetters, ExtractState, XModule, XModuleName, XModulesTree } from '../x-modules/x-modules.types';
 ...
 * @public
 */
export declare type RootStoreStateAndGetters = Pick<Store<RootXStoreState>, 'state' | 'getters'>;
/**
 ...
 * @public
 */
export declare type StoreModuleStateAndGetters<ModuleName extends XModuleName> = {
 ...
 * @public
 */
export declare type AnyXStoreModule = XStoreModule<any, any, any, any>;
/**
 ...
 * @public
 */
export declare type ExtractMutations<Module extends AnyXModule> = Module extends XModule<XStoreModule<any, any, infer Mutations, any>> ? Mutations : never;
/**
 ...
 * @public
 */
export declare type ExtractActions<Module extends AnyXModule> = Module extends XModule<XStoreModule<any, any, any, infer Actions>> ? Actions : never;
/**
 ...
 * @public
 */
export declare type ExtractPayload<SomeFunction> = SomeFunction extends (payload?: any) => any ? Parameters<SomeFunction>[0] : never;
/**
 ...
 * @public
 */
export declare type MutationNamesFor<ModuleName extends XModuleName> = keyof ExtractMutations<XModulesTree[ModuleName]>;
/**
 ...
 * @public
 */
export declare type ExtractMutationPayload<ModuleName extends XModuleName, MutationName extends MutationNamesFor<ModuleName>> = ExtractPayload<ExtractMutations<XModulesTree[ModuleName]>[MutationName]>;
/**
 ...
 * @public
 */
export declare type ActionNamesFor<ModuleName extends XModuleName> = keyof ExtractActions<XModulesTree[ModuleName]>;
/**
 ...
 * @public
 */
export declare type ExtractActionPayload<ModuleName extends XModuleName, ActionName extends ActionNamesFor<ModuleName>> = ExtractPayload<ExtractActions<XModulesTree[ModuleName]>[ActionName]>;
