 ...
 * @public
 */
export declare type GettersTree<State extends Dictionary, Getters extends Dictionary> = {
 ...
 * @public
 */
export declare type GettersClass<Module extends AnyXStoreModule> = Partial<Module['getters']>;
//# sourceMappingURL=getters.types.d.ts.map