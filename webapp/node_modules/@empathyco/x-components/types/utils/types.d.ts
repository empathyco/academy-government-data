 ...
 * @public
 */
export declare type NiladicFunction = () => any;
/**
 * A function with a single parameter that can return anything.
 *
 * @public
 */
export declare type MonadicFunction = (someParam: any) => any;
/**
 ...
 * @public
 */
export declare type Returns<T extends Dictionary<AnyFunction>> = {
 ...
 * @public
 */
export declare type DecoratorFor<Type> = <Key extends string, Target extends Record<Key, Type>>(target: Target, key: Key) => void;
/**
 * Union type containing the existing arrow keys.
 *
 * @public
 */
export declare type ArrowKey = 'ArrowUp' | 'ArrowDown' | 'ArrowRight' | 'ArrowLeft';
/**
 * Union type containing supported Vue dynamic classes.
 *
 * @public
 */
export declare type VueCSSClasses = string | Dictionary<boolean> | (string | Dictionary<boolean>)[];
/**
 * Represents a pair of values of the same type in an array.
 *
 * @public
 */
export declare type Pair<Type> = [Type, Type];
/**
 ...
 * @public
 */
export declare type TakeNavigationControl = {
 ...
 * @public
 */
export declare type EventsForDirectionLimit = {
 ...
 * @public
 */
export declare type ListItem = Identifiable & NamedModel;
/**
