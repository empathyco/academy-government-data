...
import { Facet, Filter, HistoryQuery, NextQuery, PartialResult, Redirection, RelatedTag, Result, Suggestion } from '@empathyco/x-types';
 ...
 * @public
 */
export declare type XModulesOptions = {
 ...
 * @public
 */
export declare type PrivateXModulesOptions = {
 ...
 * @public
 */
export declare type XStoreModuleOptions<StoreModule extends AnyXStoreModule> = StoreModule extends XStoreModule<infer State, infer Getters, infer Mutations, infer Actions> ? {
 ...
 * @public
 */
export declare type AnyXStoreModuleOption = XStoreModuleOptions<AnyXStoreModule>;
//# sourceMappingURL=x-plugin.types.d.ts.map