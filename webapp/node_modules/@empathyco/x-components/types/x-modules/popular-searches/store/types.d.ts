 ...
 * @public
 */
export declare type PopularSearchesXStoreModule = XStoreModule<PopularSearchesState, PopularSearchesGetters, PopularSearchesMutations, PopularSearchesActions>;
/**
 * Alias type for actions context of the {@link PopularSearchesXStoreModule}.
 *
 * @public
 */
export declare type PopularSearchesActionContext = XActionContext<PopularSearchesState, PopularSearchesGetters, PopularSearchesMutations, PopularSearchesActions>;
