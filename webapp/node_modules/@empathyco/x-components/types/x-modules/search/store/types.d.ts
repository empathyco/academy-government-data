...
import { Banner, Facet, Filter, PartialResult, Promoted, Redirection, RelatedTag, Result, Sort, TaggingRequest } from '@empathyco/x-types';
 ...
 * @public
 */
export declare type SearchXStoreModule = XStoreModule<SearchState, SearchGetters, SearchMutations, SearchActions>;
/**
 * Alias type for actions context of the {@link SearchXStoreModule}.
 *
 * @public
 */
export declare type SearchActionContext = XActionContext<SearchState, SearchGetters, SearchMutations, SearchActions>;
