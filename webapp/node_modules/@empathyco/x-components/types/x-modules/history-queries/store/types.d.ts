 ...
 * @public
 */
export declare type HistoryQueriesXStoreModule = XStoreModule<HistoryQueriesState, HistoryQueriesGetters, HistoryQueriesMutations, HistoryQueriesActions>;
/**
 * Alias type for actions context of the {@link HistoryQueriesXStoreModule}.
 *
 * @public
 */
export declare type HistoryQueriesActionContext = XActionContext<HistoryQueriesState, HistoryQueriesGetters, HistoryQueriesMutations, HistoryQueriesActions>;
