 ...
 * @public
 */
export declare type XModuleName = keyof XModulesTree;
/**
 ...
 * @public
 */
export declare type AnyXModule = XModule<AnyXStoreModule>;
/**
 ...
 * @public
 */
export declare type ExtractState<Module extends XModuleName> = XModulesTree[Module] extends XModule<XStoreModule<infer State, any, any, any>> ? State : never;
/**
 ...
 * @public
 */
export declare type ExtractGetters<Module extends XModuleName> = XModulesTree[Module] extends XModule<XStoreModule<any, infer Getter, any, any>> ? Getter : never;
