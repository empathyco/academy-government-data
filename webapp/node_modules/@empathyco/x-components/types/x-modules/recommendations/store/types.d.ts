 ...
 * @public
 */
export declare type RecommendationsXStoreModule = XStoreModule<RecommendationsState, RecommendationsGetters, RecommendationsMutations, RecommendationsActions>;
/**
 * Alias type for actions context of the {@link RecommendationsXStoreModule}.
 *
 * @public
 */
export declare type RecommendationsActionContext = XActionContext<RecommendationsState, RecommendationsGetters, RecommendationsMutations, RecommendationsActions>;
