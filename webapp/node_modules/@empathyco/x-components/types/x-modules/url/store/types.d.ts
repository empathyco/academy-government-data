 ...
 * @public
 */
export declare type UrlParamKey = Extract<keyof UrlParams, string>;
/**
 * The allowed values of the parameters to store in the URL.
 *
 * @public
 */
export declare type UrlParamValue = string | number | boolean | Array<string | number | boolean>;
/**
 * URL store mutations.
 *
 * @public
 ...
 * @public
 */
export declare type UrlXStoreModule = XStoreModule<UrlState, UrlGetters, UrlMutations, UrlActions>;
/**
 * Alias type for actions context of the {@link UrlXStoreModule}.
 *
 * @public
 */
export declare type UrlActionContext = XActionContext<UrlState, UrlGetters, UrlMutations, UrlActions>;
