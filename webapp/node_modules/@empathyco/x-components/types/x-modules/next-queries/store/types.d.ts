 ...
 * @public
 */
export declare type NextQueriesXStoreModule = XStoreModule<NextQueriesState, NextQueriesGetters, NextQueriesMutations, NextQueriesActions>;
/**
 * Alias type for actions context of the {@link NextQueriesXStoreModule}.
 *
 * @public
 */
export declare type NextQueriesActionContext = XActionContext<NextQueriesState, NextQueriesGetters, NextQueriesMutations, NextQueriesActions>;
