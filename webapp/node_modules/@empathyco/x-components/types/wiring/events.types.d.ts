 ...
 * @public
 */
export declare type XEvent = keyof XEventsTypes;
/**
 ...
 * @public
 */
export declare type XEventsOf<Type> = PropsWithType<XEventsTypes, Type>;
/**
 ...
 * @public
 */
export declare type XEventPayload<Event extends XEvent> = XEventsTypes[Event] extends void ? undefined : XEventsTypes[Event];
