 ...
 * @public
 */
export declare type Wire<PayloadType> = (observable: Observable<WirePayload<PayloadType>>, store: Store<RootXStoreState>, on: XBus['on']) => Subscription;
/**
 ...
 * @public
 */
export declare type PayloadFactoryData<Payload> = RootStoreStateAndGetters & {
 ...
 * @public
 */
export declare type WireForEvent<Event extends XEvent> = Wire<XEventPayload<Event>>;
/**
 * Alias for a wire of any type.
 *
 * @public
 */
export declare type AnyWire = Wire<any>;
/**
...
//# sourceMappingURL=wiring.types.d.ts.map