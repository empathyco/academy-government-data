 ...
 * @public
 */
export declare const animateTranslate: (animationOrigin?: import("../create-directional-animation-factory").AnimationOrigin | undefined) => import("vue").VueConstructor<import("vue").default>;
//# sourceMappingURL=animate-translate.factory.d.ts.map