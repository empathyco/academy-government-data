 ...
 * @public
 */
export declare type QueryOrigin = `${QueryFeature}:${FeatureLocation}`;
/**
 ...
 * @public
 */
export declare type ResultOrigin = `${ResultFeature}:${FeatureLocation}`;
/**
 * The name of the tool that generated the query.
 *
 * @public
 */
export declare type QueryFeature = 'search_box' | 'url' | 'query_suggestion' | 'next_query' | 'popular_search' | 'history_query' | 'partial_result' | 'related_tag' | 'spellcheck';
/**
 * The name of the tool that generated the results.
 *
 * @public
 */
export declare type ResultFeature = 'search' | 'recommendations' | 'next_query_results' | 'partial_results' | 'identifier_result';
/**
 ...
 * @public
 */
export declare type QueryOriginInit = Partial<Pick<WireMetadata, 'feature' | 'location'>>;
