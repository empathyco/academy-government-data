...
import co.empathy.indexbuilder.config.TransformerFactory;
import co.empathy.indexbuilder.operation.MappingJsonOperation;
...
public class CatalogTransformer implements Transformer<JsonOperation> {

    private final BundleDescriptor bundleDescriptor;
    private List<CatalogProcessor> processors;

    public CatalogTransformer(BundleDescriptor bundleDescriptor) {
    ...
    public JsonOperation createJsonOperation(Map<String, Object> result) {
        return new MappingJsonOperation(result);
    }
