...
import co.empathy.index.plugin.transformers.CatalogPartialTransformer;
...
@Configuration
public class CatalogPartialConfig {
    ...
    public FeedConfiguration feedConfiguration() {
        ...
        feedConfiguration.setFeedId(IndexType.CATALOG_PARTIAL.getFeedId());
        feedConfiguration.setIndexType(IndexType.CATALOG_PARTIAL.getType());
        feedConfiguration.setLangs(LANGUAGES);
        feedConfiguration.setReader(new JSONReader());
        feedConfiguration.setOpType(OpType.PARTIAL);
        feedConfiguration.setTransformerFactory(CatalogPartialTransformer::new);
